...
public:
	...
	//Método para eliminar un arco de la lista de adyacencia.
	void EliminaArco(std::shared_ptr<Arco>&);

	//Método para eliminar todos los arcos que han sido matcheados.
	void EliminaMatcheados();
